    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-3" style="text-align: center;">
                <a class="btn btn-lg btn-primary" href="{{ route('shipments.add') }}" role="button">Book Shipment</a></p>
            </div>
            <div class="col-sm-3" style="text-align: center;">
                <a class="btn btn-lg btn-primary" href="{{ route('shipments.booked') }}" role="button">Shipment - Operations</a></p>
            </div>
            <div class="col-sm-3" style="text-align: center;">
                <a class="btn btn-lg btn-primary" href="{{ route('shipments.receivedShipments') }}" role="button">Received Shipment</a></p>
            </div>
            <div class="col-sm-3" style="text-align: center;">
                <a class="btn btn-lg btn-primary" href="{{ route('shipments.awb') }}" role="button">Track Shipment</a></p>
            </div>
        </div>
    </div>
</div>
